...
do_renderer_tests(void)
{
  ...
  if (system("./examples/pdf2cairo -v testfiles/renderer/01_stroked_box.pdf -o testfiles/renderer-output/01.png ") != 0)
  {
    testEnd(false);
    status = 1;
  }
  ...
  if (system("./examples/pdf2cairo -v -p 1 testfiles/renderer/02_filled_box_rgb.pdf -o testfiles/renderer-output/02.png") != 0)
  {
    testEnd(false);
    status = 1;
  }
  ...
  if (system("./examples/pdf2cairo -v -r 300 -p 1 testfiles/renderer/03_nested_state.pdf -o testfiles/renderer-output/03.png") != 0)
  {
    testEnd(false);
    status = 1;
  }
